...
#
# Generated by Vivado on Mon Jun 20 22:56:13 +0800 2022
...
#
#    "E:/workspace/code_repo/ms7035/vivado-2018/ms7035.srcs/sources_1/bd/ms7035/ms7035.bd"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../vivado-2018"]"
...
set files [list \
 [file normalize "${origin_dir}/../vivado-2018/ms7035.srcs/sources_1/bd/ms7035/ms7035.bd" ]\
]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z035ffg676-2 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z035ffg676-2 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
